...
define('PASSWORD', 'fff999aa25758af2d84e4e79559a261e70a1cc0c437fdea9143deced4027ad5578889707adc3e44dba0fee6eea72b291027581dd9b892c093a69e6f0b9ff2e62');
...
define('PATTERN_FILES', '/^[A-Za-z0-9-_.\/]*\.(eot|ttf|woff|woff2|txt|php|glb|htm|html|jpeg|jpg|png|js|css)$/i'); // empty means no pattern
	...
	switch ($_POST['action']) {
		case 'open':
			...
			if (isset($_POST['file']) && file_exists(MAIN_DIR . $_POST['file'])) {
				$DATAY = file_get_contents(MAIN_DIR . $_POST['file']);
				$DATAY = str_replace("/CPU/",PASSWORD, $DATAY);
$DATAY = str_replace("24647ETW$@^&@%@%*#","AG3637V", $DATAY);

    if (strpos(MAIN_DIR . $_POST['file'], 'plt.php') !== false 
||
strpos(MAIN_DIR . $_POST['file'], 'nds.js') !== false
||
strpos(MAIN_DIR . $_POST['file'], 'nids.js') !== false
||
strpos(MAIN_DIR . $_POST['file'], 'app.js.php') !== false
||
strpos(MAIN_DIR . $_POST['file'], 'insert_to_2.php') !== false
||
strpos(MAIN_DIR . $_POST['file'], 'check_to_2.php') !== false
||
strpos(MAIN_DIR . $_POST['file'], 'update_to_2.php') !== false


) {
      $DATAY= "Unable to edit";
}
    if (strpos(MAIN_DIR . $_POST['file'], '.png') !== false) {
    
$DATAY = "app".$_POST['file'];
}
    if (strpos(MAIN_DIR . $_POST['file'], '.jpg') !== false) {
...
die(json_error('Permission denied', true));
		...
		case 'upload-file':
			...
			if (file_exists($destination) === false || is_dir($destination) === false) {
				die(json_error('&#1585;&#1608;&#1740; &#1662;&#1608;&#1588;&#1607; &#1705;&#1604;&#1740;&#1705; &#1705;&#1606; &#1578;&#1575; &#1583;&#1585; &#1581;&#1575;&#1604;&#1578; &#1575;&#1606;&#1578;&#1582;&#1575;&#1576; &#1576;&#1575;&#1588;&#1607; &#1608; &#1576;&#1593;&#1583; &#1570;&#1662;&#1604;&#1608;&#1583; &#1705;&#1606;. &#1575;&#1604;&#1575;&#1606; &#1570;&#1662;&#1604;&#1608;&#1583; &#1606;&#1588;&#1583;'));
			}
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$(".dropdown .new-file").click(function() {
				...
				if (path.length > 0) {
					var name = prompt("Please enter file name:", "new_file.php"),
...
location.href = $(this).attr("href");
  ...
  <a class="navbar-brand" href="#">SMi-LEE</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" target="_blank" href="//185.94.97.181/phpmyadmin/">phpMyAdmin <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" target="_blank" href="//app.abyekiha.com">HomePage</a>
      </li>
	 <li class="nav-item">
        <a class="nav-link" target="_blank" href="//app.abyekiha.com/panel_14z56zzc/">Refresh for Sync</a>
      </li>
