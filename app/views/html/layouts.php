...
<div id="dear_nav" class="dear_element">
</div>
<div  id="hidden" class="dear_element">
</div>
<div  id="app_msg" class=" m-2 grey-text text-darken-1 dear_element app_msg text-danger">
</div>
...
<div id="s_popModal" class="fade-in" style="display:none">	
		...
		<div class="s_pop m-2">
			<div class="w-100 border-bottom" onclick="if_show_hide('s_popModal');history.back(-1)"><h1 class="close_x" >&times;</h1></div>
			<div class="m-3">
