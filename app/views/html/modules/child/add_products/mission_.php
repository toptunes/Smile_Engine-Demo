                ...
                <form class="row  ">
                    ...
                    <div class="col-12 c_box">
                        <p class="info_s">فقط نام محصول
                            <b class="text-danger">( بدون اضافه کردن نام برند , حجم و یا مدل)</b>
                        </p>
                        <input class="form-control input_m_form" type="hidden" name="next_mission" value="2">
                        <input class="form-control input_m_form jm "
                            data-msg="نام محصول وارد نشده . نوشتن نام محصول اجباری است" type="text" data-req="1"
                            name="product_name" placeholder="نام محصول">
                    </div>


                    <div class="col-6 c_box fs-6">
                        <span class="info_s">اگر برند ندارد خالی بگذارید</span>
                        <input class="fs-6 form-control input_m_form jm" type="text" name="brand_name"
                            placeholder="نام برند">
                    </div>

                    <div class="col-6 c_box fs-6">
                        <span class="info_s">نوع خاصی ندارد خالی بگذارید</span>
                        <input class="fs-6 form-control input_m_form jm" type="text" name="product_model"
                            placeholder="نام مدل / نوع">
                    </div>
                    ...
                    <div class="col-6 c_box">
                        ...
                        <input class="form-control input_m_form jm"
                            onchange="percent_c_js(\'product_real_price\',\'product_off_price\',\'percent_c\',\'1\')"
                            onfocusout="percent_c_js(\'product_real_price\',\'product_off_price\',\'percent_c\')"
                            type="number" data-msg="فیلد قیمت نباید خالی باشد" data-req="1" id="product_real_price"
                            name="product_real_price" placeholder="0">
                    </div>
                    <div class="col-6 c_box">
                        <div class="info_s">
                        ...
                        <input onclick="this.select()"
                            ...
                            onfocusout="percent_c_js(\'product_real_price\',\'product_off_price\',\'percent_c\')"
                            class="form-control input_m_form jm" type="number"
                            data-msg="مقدار تخفیف نباید خالی باشد اگر این محصول تخفیف ندارد همان قیمت اصلی را به فیلد (قیمت بعد از تخفیف) بنویسید"
                            id="product_off_price" name="product_off_price" data-req="1" value="0">
                    </div>
                    <div class="col-6 c_box">
                    ...
                    <div class="col-6 c_box">
                        ...
                        <input onclick="this.select()"
                            ...
                            class="form-control input_m_form jm" type="text" id="percent_c" name="product_takhfif"
                            data-req="1" value="0" data-msg="عدد درصد تخفیف نباید خالی باشد حداقل عدد 0 بگذارید">
                    ...
                    <div id="submit_id_control_in_msg" class="col-12 ">
                        ...
                        <a id="form_submit" data-query="insert_to_(products)&next=add_product&mission=2&tab=1"
                            data-msg="'.$read_t['data_fill_all'].'"
                            class="btn btn-lg abyekiha_bg float-end btn_id">ثبت و ادامه</a>
